...
/**
 * Utility class for generating card numbers using the Luhn algorithm.
 */
public class CardNumberGenerator {
  ...
  /**
   * Generates a card number with a valid check digit.
   *
   ...
   * @throws IllegalArgumentException If the number contains non-numeric characters or is null.
   */
